...
RSpec.describe CropsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all crops as @crops" do
      ...
      expect(assigns(:crops)).to eq([crop])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new crop as @crop" do
      ...
      expect(assigns(:crop)).to be_a_new(Crop)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created crop as @crop" do
        post :create, {:crop => valid_attributes}, valid_session
        expect(assigns(:crop)).to be_a(Crop)
        expect(assigns(:crop)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved crop as @crop" do
        post :create, {:crop => invalid_attributes}, valid_session
        expect(assigns(:crop)).to be_a_new(Crop)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested crop" do
        crop = Crop.create! valid_attributes
        put :update, {:id => crop.to_param, :crop => new_attributes}, valid_session
        crop.reload
    ...
    context "with invalid params" do
      it "assigns the crop as @crop" do
        crop = Crop.create! valid_attributes
        put :update, {:id => crop.to_param, :crop => invalid_attributes}, valid_session
        expect(assigns(:crop)).to eq(crop)
      end
